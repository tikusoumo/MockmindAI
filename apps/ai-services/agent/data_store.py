...
class DataStore:
    ...
    interview_templates: list[dict[str, Any]] = field(default_factory=list)
    progress_stats: list[dict[str, Any]] = field(default_factory=list)
...
def add_scheduled_session(payload: dict[str, Any]) -> dict[str, Any]:
    session = {
