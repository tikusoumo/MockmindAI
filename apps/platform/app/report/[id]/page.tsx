...
export default function ReportDetailPage() {
  ...
  const report = useBackendData<ReportData>(endpoint, fallbackReport);

  const isLoading = !report || report.id === fallbackReport.id;
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={report.timelineData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                <defs>
              ...
              <Card key={key}>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {typeof value === 'object' && value !== null ? (value as any).score || JSON.stringify(value) : String(value)}
                  </div>
                </CardContent>
              </Card>
            ))}
