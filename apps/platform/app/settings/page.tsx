            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" defaultValue="alex.chen@example.com" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="level">Experience Level</Label>
                  <Input id="level" defaultValue={currentUser.level} />
                </div>
              </div>
            </CardContent>
            <CardFooter>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive emails about your interview results.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get reminded 1 hour before your scheduled sessions.
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground">
                  Use the toggle in the top navigation bar to switch between Light and Dark modes.
                </div>
              </div>
            </CardContent>
          </Card>
